...
var minimizeZeroes = function(array) {
  ...
  if(array[0] !== 0 || (array[0] === 0 && array[1] !== 0)) return [array[0]].concat(minimizeZeroes(array.slice(1)));
...
var alternateSign = function(array) {
  ...
  if(array[1] > 0) {
    return [Math.abs(array[0]), -(array[1])].concat(alternateSign(array.slice(2)))
  } else {
    return [Math.abs(array[0]), array[1]].concat(alternateSign(array.slice(2)))
  }
};
